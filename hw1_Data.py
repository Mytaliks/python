...
today = Data('12 - 2 - 2022')
print(today)
print(Data.valid(45, 11, 2020))
print(Data.extract('45 - 11 - 2020'))
print(Data.valid(11, 13, 2022))
print(Data.extract('11 - 13 - 2022'))
print(today.valid(11, 5, 2026))
print(today.extract('11 - 5 - 2026'))
print(Data.valid(12, 2, 2022))
